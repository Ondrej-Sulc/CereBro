    ...
    return (
        <div className="space-y-4 animate-in slide-in-from-top-2 fade-in duration-300">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-2">
                ...
                <div className="flex items-center gap-2">
                    <Label className="text-xs text-slate-400 font-medium">Show Limit</Label>
                    <Select value={String(limit)} onValueChange={(val) => onLimitChange(parseInt(val))}>
                        <SelectTrigger className="h-8 w-[80px] bg-slate-900/50 border-slate-800 hover:border-slate-700 text-slate-300 transition-colors">
                            <SelectValue />
                        </SelectTrigger>
