...
export const championClassColorMap: Record<ChampionClass, { text: string; border: string; bg: string; color: string }> = {
  SCIENCE:  { text: 'text-green-500',  border: 'ring-2 ring-inset ring-green-500/75',  bg: 'bg-green-500/20',  color: '#22c55e' }, // green-500
  SKILL:    { text: 'text-red-500',    border: 'ring-2 ring-inset ring-red-500/75',    bg: 'bg-red-500/20',    color: '#ef4444' },   // red-500
  MYSTIC:   { text: 'text-purple-600', border: 'ring-2 ring-inset ring-purple-600/75', bg: 'bg-purple-600/20', color: '#9333ea' }, // purple-600
