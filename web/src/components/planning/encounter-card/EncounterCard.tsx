...
import { 
    ...
    Filter, Info, PlayCircle, Search, Shield, ShieldAlert, Swords, TagIcon, Trash2, 
    X, Youtube, Zap, BookOpen, Users, Target, Ban
} from "lucide-react";
import { 
...
import { EnhancedCountersMap, PopularCountersMap } from "@/app/actions/quests";
...
export interface EncounterCardProps {
    ...
    encounterTabs: Record<string, 'recommended' | 'featured' | 'alliance'>;
    setEncounterTabs: React.Dispatch<React.SetStateAction<Record<string, 'recommended' | 'featured' | 'alliance'>>>;
    featuredPicks: EnhancedCountersMap;
    alliancePicks: EnhancedCountersMap;
    popularCounters: PopularCountersMap;
    renderChampionItem: (c: any, encounter: any, popularityLabel?: string, isRecommended?: boolean) => React.ReactNode;
    renderListPick: (p: any, encounter: any) => React.ReactNode;
