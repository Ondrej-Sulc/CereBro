            ...
            {displayedQuests.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                    {displayedQuests.map(quest => (
                        <Card
                            key={quest.id}
                            className="bg-slate-950 border-slate-800 hover:border-sky-700/50 hover:shadow-[0_0_30px_rgba(2,132,199,0.1)] transition-all cursor-pointer group overflow-hidden flex flex-col relative before:absolute before:inset-0 before:bg-gradient-to-b before:from-sky-500/5 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity"
