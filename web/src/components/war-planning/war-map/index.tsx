...
const WarMap = memo(function WarMap({
  ...
  const mapHeight = currentLayout.HEIGHT * scale;
  ...
  // Y constraints  
  // When panning up (negative Y): map bottom (pos.y + mapHeight) must be at least minVisibleHeight from top
  // When panning down (positive Y): map top (pos.y) must be at most (viewportHeight - minVisibleHeight)
  const minY = minVisibleHeight - mapHeight;
