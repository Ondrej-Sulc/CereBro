...
import { Maximize2, Minimize2, History, Swords, Shield } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';
import { getBatchHistoricalCounters, HistoricalFightStat } from '@/app/planning/history-actions';
import { TransformWrapper, TransformComponent, ReactZoomPanPinchRef } from 'react-zoom-pan-pinch';
import { WarFight, WarNode, WarNodeAllocation, NodeModifier, WarTactic, ChampionClass, War } from '@prisma/client';
...
const WarMapBackground = React.memo(function WarMapBackground() {
...
const WarNodeGroup = React.memo(function WarNodeGroup({ 
    node, 
    fight, 
    isSelected, 
    onNodeClick,
