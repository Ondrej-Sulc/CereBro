    ...
    <Popover open={open} onOpenChange={setOpen}>
                ...
                <PopoverTrigger asChild>
                  ...
                  <Button
                    ...
                    className={cn("w-full justify-between pr-2 pl-0 rounded-full h-auto min-h-[44px] py-1", className)}
                       ...
                       {selectedChampion ? (
                          ...
                          <>
                              ...
                              <div 
                                  ...
                                  className={cn("relative h-9 w-9 rounded-full overflow-hidden flex-shrink-0 bg-slate-800", getChampionClassColors(selectedChampion.class).border)}
                              ...
                              <span 
                                  ...
                                  className={cn("font-bold text-sm text-left whitespace-normal leading-tight line-clamp-2", getChampionClassColors(selectedChampion.class).text)}
                          ...
                          <span className="text-slate-500 text-sm pl-3 truncate">{placeholder}</span>
        ...
        <Command shouldFilter={false}>
          ...
          <CommandList className="overflow-hidden">
            ...
            <CommandGroup>
                ...
                <div style={{ height: Math.min(flatItems.length * 52 + groupNames.length * 28, 300) }}>

                  <GroupedVirtuoso

                    style={{ height: Math.min(flatItems.length * 52 + groupNames.length * 28, 300) }}
                    ...
                    itemContent={(index) => {
                      ...
                      return (
                        ...
                        >
                            ...
                            <span className={cn("font-medium text-sm leading-tight whitespace-normal", colors.text)}>
